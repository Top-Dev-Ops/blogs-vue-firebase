    ...
    <header>
        ...
        <nav class="container">
            ...
            <div class="nav-links">
                ...
                >
                    <span>{{this.$store.state.profile.initials}}</span>
                    <div class="profile-menu" v-show="profileMenu">
                        <div class="info">
                            <p class="initials">{{this.$store.state.profile.initials}}</p>
                            <div class="right">
                                <p>{{this.$store.state.profile.firstName}} {{this.$store.state.profile.lastName}}</p>
                                <p>{{this.$store.state.profile.userName}}</p>
